/////////////////////////////////
// tdn_tool_1
// OnUse for ItemRenamer
// Written: 02/10/2020
// Written By: InfyDae
//
//
// Description: Allows you to set the name of the targeted object
////////////////////////////////////
...
void main()
{
  ...
  string explanation = "You are using the Item Renamer. The next sentence spoken by your character will be the new name of [";
  ...
  SetLocalObject(oPC, "ObjectToSetName", oTarget);
}
